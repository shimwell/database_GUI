...
def make_json_obj_from_evaluation_file(root,file):
    ...
    if products.startswith('none found') ==False:
        ...
        data = {#'Element':element_full,
                ...
                'Protons / Element':str(proton_number) +' ' + element.title() +' ' + element_full,
...
def make_json_obj_from_exfor_file(root,file):
    ...
    if products.startswith('none found')==False:
        ...
        data = {#'Element':element_full,
                ...
                'filename':str(element.title()+nucleon_number+' '+incident_particle+','+products+' '+ library + ' ' + experiment_id).replace(' ','_'),
                'Energy': energy,
                'Cross section': xs,
